...
- **Handoff:** After making code changes, end the completion report with one suggested conventional commit message that accurately describes the final diff. Omit it only when no code changed.
